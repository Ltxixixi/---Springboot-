...
) ENGINE=InnoDB AUTO_INCREMENT=2019409244143583235 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `barrage` VALUES ('2019409244143583234', 'hellow', 'null', '2019407186799722498', '0', '2026-02-05 21:54:17', '2026-02-05 21:54:17', '0');
...
) ENGINE=InnoDB AUTO_INCREMENT=1890699195636756483 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='帖子';
...
INSERT INTO `post` VALUES ('1885961164446900226', '测试内容1', '2323', '[\"Python\",\"Java\"]', '0', '1', '6', '2025-02-02 15:59:15', '2026-03-22 00:15:22', '0');
...
CREATE TABLE `post_favour` (
  ...
  KEY `idx_userId` (`userId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2035389815546011651 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='帖子收藏';
...
INSERT INTO `post_favour` VALUES ('2035389815546011650', '1885961164446900226', '6', '2026-03-22 00:15:22', '2026-03-22 00:15:22');
...
CREATE TABLE `post_thumb` (
  ...
  KEY `idx_postId` (`postId`) USING BTREE,
  KEY `idx_userId` (`userId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2035389814887505923 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='帖子点赞';
...
CREATE TABLE `spot` (
  ...
  `isDelete` tinyint NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1893908474128637955 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
) ENGINE=InnoDB AUTO_INCREMENT=1894999998342070275 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `spot_fee` VALUES ('1894991418918432770', '1893907615818850305', '5', '数量 900 张 7折', '60.00', '899', '1', '2025-02-27 14:02:16', '2025-02-27 14:03:04', '0');
...
) ENGINE=InnoDB AUTO_INCREMENT=2035389867484078083 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `spot_order` VALUES ('2035389867484078082', '6', '1894991418918432770', '', '', '60.00', '1', '2026-03-22 00:15:34', '2026-03-22 00:15:34', '0');
...
CREATE TABLE `spot_route` (
  ...
  `isDelete` tinyint NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1894241082674937858 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
) ENGINE=InnoDB AUTO_INCREMENT=2035389845820497922 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `spot_score` VALUES ('2019407963106672641', '1893908474128637954', '2019407186799722498', '5', '2026-02-05 21:49:11', '2026-02-05 21:49:11', '0');
INSERT INTO `spot_score` VALUES ('2035389845820497921', '1893907615818850305', '6', '5', '2026-03-22 00:15:29', '2026-03-22 00:15:29', '0');
...
CREATE TABLE `user_ai_message` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2035383296456744963 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
) ENGINE=InnoDB AUTO_INCREMENT=2019409100287344643 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `user_spot_favorites` VALUES ('2019407932744105986', '2019407186799722498', '1893908474128637954', '1', null, '0', '2026-02-05 21:49:04', '2026-02-05 21:49:04');
INSERT INTO `user_spot_favorites` VALUES ('2019409100287344642', '2019407186799722498', '1893908368084049922', '1', null, '0', '2026-02-05 21:53:42', '2026-02-05 21:53:42');
